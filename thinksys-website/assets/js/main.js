// $("ul").addClass('list-style');
$("footer ul, .testimonials-container ul, .client-in ul, .plan-list ul, .toolkit-main ul").removeClass('list-style');
$(".accordionTabList").removeClass('list-style');
...
// wp-homepage swiper starts here

var home_swiper = new Swiper('.homeSwiper', {
  slidesPerView: 6,
  spaceBetween: 30,
  freeMode: true,
  pagination: {
